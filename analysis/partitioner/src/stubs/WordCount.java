...
public class WordCount extends Configured implements Tool{
  ...
  public static void main(String[] args) throws Exception {
	...
	public int run(String[] args) throws Exception {
	     ...
	     * command-line arguments is not exactly 2.sss
	     */
	    if (args.length != 2) {
	      System.out.printf(
	          "Usage: WordCount [-files path,...] <input dir> <output dir>\n");
	      System.exit(-1);
	    }
	     ...
	     * and setting number of reduce tasks
	     */
	    ...
	    System.out.println(job.getCacheFiles().length);
	    return success ? 0 : 1;
	}
}
